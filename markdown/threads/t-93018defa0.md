...
- **Message-ID:** `<326B1984.74C@ix.netcom.com>`

```

Are there any sites where I can download a COBOL compilers for use on my
PC? I need something that will work just to freshen up my COBOL
programming. Any info would be appreciated!!
```
...
- **Newsgroups:** comp.lang.cobol
- **Message-ID:** `<gap-93018defa0-p2@usenetarchives.gap>`
- **In-Reply-To:** `<326B1984.74C@ix.netcom.com>`
- **References:** `<326B1984.74C@ix.netcom.com>`
...
Have a look at http://www.enter.net/~flexus/
```
...
- **Newsgroups:** comp.lang.cobol
- **Message-ID:** `<gap-93018defa0-p3@usenetarchives.gap>`
- **In-Reply-To:** `<326B1984.74C@ix.netcom.com>`
- **References:** `<326B1984.74C@ix.netcom.com>`
