...
- **From:** "wmk..." <ua-author-14039938@usenetarchives.gap>
- **Date:** 1998-04-25T20:00:01+00:00
- **Newsgroups:** comp.lang.cobol
- **Message-ID:** `<ua-fallback-oqM-OQmYX4A@usenetarchives.gap>`
...
4.4a for Amiga?
According to Har··.@car··c.uk (on March 2, 1998),
...
5.2 Computer Associates/Realia
5.2.1 CA-Realiaï¿½ II Workbench
CA-Realiaï¿½ II Workbench provides an exciting mainframe-compatible
...
which supports the Javaï¿½ Virtual Machine, including Network
...
5.5 Micro Focus
5.5.1 Micro Focusï¿½ Object COBOL v4.0 (32-bit) for OS/2
...
Object COBOL applications for OS/2.ï¿½ Micro Focus has brought the
power of COBOL to the PC with extensive syntax support, including
object oriented COBOL, IBMï¿½ OS/VS COBOL, DOS COBOL, COBOL/370ï¿½
...
5.5.2 Micro Focusï¿½ NetExpress V2.0 for Windows NT and Windowsï¿½ 95
NetExpress combines Micro Focus Object COBOLï¿½ with a specialized
...
5.5.3 Object COBOL ï¿½ D e v e l o p e r Suite v4.1 for UNIX
...
applications on a wide range of UNIX ï¿½ operating environments. It
...
e-mail (sales) : rm_··.@li··t.com
e-mail: (support) rm_··.@li··t.com
...
ï¿½ max. 800 lines of code
ï¿½ max. 4 files
ï¿½ max. 1000 records per file
ï¿½ max. 100 bytes per file record
...
ACUCOBOLï¿½-GT enables COBOL programmers to implement and deliver
...
ï¿½ High quality Cobol Parser that parses 12 most popular Cobol
dialects and that has tremendous error recovery capability.
ï¿½ C++ library that client uses to browse and transform the
...
general case Graph.
ï¿½ PrettyPrinter that transforms our Internal Representation
...
platform, cross product compilers which support OS/2ï¿½, OS/390ï¿½,
MVSï¿½, VM, VSE/ESAï¿½, AS/400ï¿½, AIXï¿½, and Windowsï¿½. IBM gives you
...
17. What about the Y2K (Millenium) Issue?
ï¿½ Yes, the year 2000 IS a leap year
ï¿½ Yes, the millenium really starts on January 1, 2001 - but
...
these sites.
ï¿½ Comp.lang.cobol is the preferred site to use - especially
for technical issues related to COBOL.
ï¿½ Although threads do stray from the topics, the more targeted
...
ï¿½ When asking about a specific structure, error message, or
...
ï¿½ Make it clear from the beginning that you are asking for
...
ï¿½ Make certain that you specify what compiler and operating
...
ï¿½ The more information that you can give that demonstrates
...
ï¿½ Always, ALWAYS, include rates, a range of rates, or your
...
ï¿½ Try to give the best summary of job location and desired
...
ï¿½ The newsgroups are international in nature, but are
...
ï¿½ In general, the more information that you provide in your
...
Appendix A.2 - Changes to create Version 2.05
ï¿½ Significant reformatting
ï¿½ Updated OO COBOL Section
ï¿½ Add URL for IBM COBOL Web site
ï¿½ Added information on "COBOL for Dummies"
ï¿½ Added initial Y2K section
ï¿½ Added information on using the newsgroups
ï¿½ Added information on PCYACC

Appendix A.3 - Changes to create Version 2.08
ï¿½ Started adding Logos
ï¿½ Removed the detailed list of FAQ contributors
ï¿½ Fixed erroneous Standards information
ï¿½ Corrected information about Liant (who acquired RM)
ï¿½ Added information on Amiga freeware compiler
ï¿½ Added information on Siber tools
ï¿½ Corrected CA company and product information
ï¿½ Added information on where to turn for information not in
the FAQ
ï¿½ Rephrased the information on what can/should be put in the
newsgroups.
ï¿½ Revised the information on the CobCy project/product
ï¿½ Updated Micro Focus information
ï¿½ Added URL for "Dice" for those looking for COBOL jobs.
ï¿½ Added information on getting a "COBOL Tutor"

Appendix A.4 - Changes to create Version 2.0x
ï¿½ Added and corrected information on Fujitsu
ï¿½ Re-instated the information on obtaining a copy of the draft
COBOL Standard.
```
