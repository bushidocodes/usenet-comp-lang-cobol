...
- **Message-ID:** `<3193acbe.6421776@news.ultranet.com>`
...
- **Date:** 1996-05-11T20:00:02+00:00
- **Newsgroups:** comp.lang.cobol
- **Message-ID:** `<gap-82d2393464-p2@usenetarchives.gap>`
- **In-Reply-To:** `<3193acbe.6421776@news.ultranet.com>`
- **References:** `<3193acbe.6421776@news.ultranet.com>`

```

In message <<319··.@new··t.com>> s.··.@ult··t.com writes:
› 
› (2) TECHNICAL SUPPORT ANALYSTS
…[6 more quoted lines elided]…
› and some future development for the system.

This is getting too much. While I have no particular objection
to the posting of _COBOL_related_ job adds, this one has
absolutely _nothing_ to do with Cobol.

Get these bozos to piss off.
```
