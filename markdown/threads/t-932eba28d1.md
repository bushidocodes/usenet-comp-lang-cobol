...
- **Message-ID:** `<ua-fallback-Dx_voyZj8-Y@usenetarchives.gap>`
...
- **From:** "ssa..." <ua-author-5569482@usenetarchives.gap>
- **Date:** 1994-11-21T10:42:02+00:00
- **Newsgroups:** comp.lang.cobol
- **Message-ID:** `<gap-932eba28d1-p2@usenetarchives.gap>`
- **In-Reply-To:** `<ua-fallback-Dx_voyZj8-Y@usenetarchives.gap>`
- **References:** `<ua-fallback-Dx_voyZj8-Y@usenetarchives.gap>`

```
In article jf··.@mfl··o.uk (James Fidell) writes:
...
|
There are 2 more products which are OOCOBOL.
One is from IBM and another is from Hitachi.


Let me describe Hitachi's product a little bit.
It does support subset of the current language standard,
namely garbage collection, multiple inheritance and
type conformance, however it does not support persistent
objects unlike MF.
```
