...
- **From:** "jfid" <ua-author-49231142@usenetarchives.gap>
- **Date:** 1995-06-20T20:00:01+00:00
- **Newsgroups:** comp.lang.cobol
- **Message-ID:** `<cobol_803771504@hermione.demon.co.uk>`

```
Archive-name: cobol-faq
Posting-Frequency: every 30 days
Last-Modified: $Date: 1995/06/21 22:45:50 $
Version: $Revision: 1.92 $

[ Please note that the FAQ-maintainer's address has changed to
ja··s@her··o.uk ]


Additional information and corrections are encouraged. Please send
comments to jf··d@her··o.uk.
...
12.5 CA WWW server
12.6 Ryan McFarland WWW server
...
Added URL for the new location of the HTML version of the COBOL FAQ.
Misc. spelling, grammar and typo corrections.
Expanded the Windows NT COBOL entry (a little).
Split up Liant and Ryan McFarland entries.
Added URL for RM's WWW server.
RM have a product for OpenVMS.
...
available via e-mail from the author (jf··d@her··o.uk).
...
Ryan McFarland have been bought by Liant Software Corp., but
still trade as an autonomous business unit. This entry will
be removed from the FAQ in the near future.
...
RM has a WWW server at http://www.laint.com/rm/. By implication,
this should mean that Liant has a WWW server too. This information
will be updated for the next FAQ.
...
This FAQ is copyright 1994, 1995 by James Fidell. It may be freely
...
mileage may vary.
 ...
 "Yield to temptation --             | Work: ja··s@OiT··o.uk
  it may not pass your way again"    | Play: ja··s@her··o.uk
