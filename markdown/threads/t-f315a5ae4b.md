...
# Has anyone done a F.A.Q. for this newsgroup?I
...
- **Message-ID:** `<6a13or$o5g@dfw-ixnews9.ix.netcom.com>`

```

I have only been really watching this newsgroup (this time) for a few weeks,
but I was wondering if anyone has done a F.A.Q. for it. I know that
newsgroups don't keep items forever, but I was thinking of doing something
like this - and I could repost it every other week or so. On the other
hand, if it has already been done - and is out on someone's homepage, I
would be happy NOT to duplicate someone else's work.

Some of the questions, that look to me to be good candidates are:

1) Can I post job offers here (and what should I include if I do)?

2) Isn't COBOL a dead language today?

3) Where can I find out about the differences between IBM's old COBOLs and
new COBOLs? (including a list of what their real names and support are)

3) Where can I get a free (cheap) COBOL compiler for the PC? Are there any
"visual" COBOLs like visual Basic?

4) Where can I get a free (cheap) copy of the ANSI Standard? Is there a
place online? (How about online copies of other COBOL manuals and books?)

5) How do I do the following "basic/simple" thing in COBOL (for my
homework)? Can you help me with this complex thing I need to do in COBOL?

* * * * * * * *

Does this look like a useful thing to do? Does it already exist? If you
would like me to do a draft (for newsgroup input), what other questions
would you like to see in it?
```

#### ↳ Re: Has anyone done a F.A.Q. for this newsgroup?I

- **From:** "arnold trembley" <ua-author-6588869@usenetarchives.gap>
- **Date:** 1998-01-18T19:00:02+00:00
- **Newsgroups:** comp.lang.cobol
- **Message-ID:** `<gap-f315a5ae4b-p2@usenetarchives.gap>`
- **In-Reply-To:** `<6a13or$o5g@dfw-ixnews9.ix.netcom.com>`
- **References:** `<6a13or$o5g@dfw-ixnews9.ix.netcom.com>`

```
William M. Klein wrote:
›
› I have only been really watching this newsgroup (this time) for a few weeks,
› but I was wondering if anyone has done a F.A.Q. for it.

Here is an old one. I don't think it's maintained anymore.comp.lang.cobol FAQ
