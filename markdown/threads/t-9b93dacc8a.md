...
- **Message-ID:** `<computer-lang/cobol-faq_892210312@rtfm.mit.edu>`
...
Last-Modified: Saturday, April 04, 1998
...
3.1 for DOS, Windows, or OS/2?
Acucorp, CA, Liant, IBM, and Micro Focus all produce compilers
for one or more of these environments. Microsoft used to re-badge
the Micro Focus compiler, but not any more.
...
under Windows/NT. Liant has both 16 bit and 32 bit development
systems for Windows, Win95 and NT. Computer Associates' CA-Realia
II Workbench Release 3.0 provides a 32-bit COBOL compiler and
runtime. IBM's VisualAge for COBOL is also available for
Windows/NT.

3.3 for UNIX?
Acucorp, Liant, and Micro Focus have products available across a
large number of UNIX platforms. Some OEMs re-badge and/or re-
engineer these products for their own systems too.
...
However, several books in the booklists come with a COBOL
compiler. See section 10 for details.
...
PowerCOBOL to those who register at
http://www.adtools.com/

4.2 for Windows/NT?
The CP/M compiler/emulator combination should work here too; as
does the Fujitsu compiler.
...
5.1 Micro Focus
5.1.1 Micro Focus=AE Object COBOL v4.0 (32-bit) for OS/2
...
Object COBOL applications for OS/2.=AE Micro Focus has brought the
power of COBOL to the PC with extensive syntax support, including
object oriented COBOL, IBM=AE OS/VS COBOL, DOS COBOL, COBOL/370=99
...
5.1.2 Micro Focus=AE NetExpress V2.0 for Windows NT and Windows=AE 95
NetExpress combines Micro Focus Object COBOL=99 with a specialized
...
5.1.3 Object COBOL =99 D e v e l o p e r Suite v4.1 for UNIX
...
applications on a wide range of UNIX =AE operating environments. It
...
5.4 Computer Associates/Realia
5.4.1 CA-Realia=AE II Workbench
CA-Realia=AE II Workbench provides an exciting mainframe-compatible
...
probably because they are very large and are copyrighted by ANSI
and/or ISO, although the issue of copyright is put into doubt
...
C. In the category of "old technology" getting a new face
lift and being added to the Standard (as required) see Report Writer
...
features. In order to see a copy of the latest draft of the
current definition see 7.2 Can I get the standards via FTP ?
...
ISBN 3-8006-1673-4
By Andreas Tietz, published by Vahlen Verlag, M=FCnchen.
...
=B7 max. 800 lines of code
=B7 max. 4 files
=B7 max. 1000 records per file
=B7 max. 100 bytes per file record
...
ACUCOBOL=AE-GT enables COBOL programmers to implement and deliver
...
=B7 High quality Cobol Parser that parses 12 most popular Cobol
dialects and that has tremendous error recovery capability.
=B7 C++ library that client uses to browse and transform the
...
general case Graph.
=B7 PrettyPrinter that transforms our Internal Representation
...
platform, cross product compilers which support OS/2=AE, OS/390=99,
MVS=99, VM, VSE/ESA=99, AS/400=AE, AIX=AE, and Windows=AE. IBM gives y=
ou
...
17. What about the Y2K (Millenium) Issue?
=B7 Yes, the year 2000 IS a leap year
=B7 Yes, the millenium really starts on January 1, 2001 - but
...
these sites.
=B7 Comp.lang.cobol is the preferred site to use - especially
for technical issues related to COBOL.
=B7 Although threads do stray from the topics, the more targeted
...
=B7 When asking about a specific structure, error message, or
...
=B7 Make it clear from the beginning that you are asking for
...
=B7 Make certain that you specify what compiler and operating
...
=B7 The more information that you can give that demonstrates
...
NOTE: if you are looking for a COBOL tutor, (and don=92t want to
...
=B7 Always, ALWAYS, include rates, a range of rates, or your
...
=B7 Try to give the best summary of job location and desired
...
=B7 The newsgroups are international in nature, but are
...
=B7 In general, the more information that you provide in your
...
Appendix A.2 - Changes to create Version 2.05
=B7 Significant reformatting
=B7 Updated OO COBOL Section
=B7 Add URL for IBM COBOL Web site
=B7 Added information on "COBOL for Dummies"
=B7 Added initial Y2K section
=B7 Added information on using the newsgroups
=B7 Added information on PCYACC

Appendix A.3 - Changes to create Version 2.08
=B7 Started adding Logos
=B7 Removed the detailed list of FAQ contributors
=B7 Fixed erroneous Standards information
=B7 Corrected information about Liant (who acquired RM)
=B7 Added information on Amiga freeware compiler
=B7 Added information on Siber tools
=B7 Corrected CA company and product information
=B7 Added information on where to turn for information not in
the FAQ
=B7 Rephrased the information on what can/should be put in the
newsgroups.
=B7 Revised the information on the CobCy project/product
=B7 Updated Micro Focus information
=B7 Added URL for "Dice" for those looking for COBOL jobs.
=B7 Added information on getting a "COBOL Tutor"
