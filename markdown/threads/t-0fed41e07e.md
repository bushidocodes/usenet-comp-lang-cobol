...
- **Message-ID:** `<ua-fallback-7ikF5vKma4Q@usenetarchives.gap>`

```
Archive-name: cobol-faq
Posting-Frequency: every 30 days
Last-Modified: $Date: 1995/11/18 18:47:27 $
...
Micro Focus have a new address in the UK.

A freely-available linker, sl101a.zip, appears to work with COBOL650.

A WWW page exists for COBCY, a freely-available COBOL to C converter.
