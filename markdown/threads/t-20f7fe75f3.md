...
# GET OUT OF DEBT BEFORE THE MARKET CRASHES
...
- **From:** "j..." <ua-author-476465@usenetarchives.gap>
- **Date:** 1996-02-02T19:00:01+00:00
- **Newsgroups:** comp.lang.cobol
- **Message-ID:** `<4ev0b3$d2s@tofu.alt.net>`
...
provided the mostdetailed, yet straightforward instructions on
...
people
to
receive it and have it downloaded to their hard drive. That way
...
#### ↳ Re: GET OUT OF DEBT BEFORE THE MARKET CRASHES

- **From:** "c82..." <ua-author-13525796@usenetarchives.gap>
- **Date:** 1996-02-07T19:00:02+00:00
- **Newsgroups:** comp.lang.cobol
- **Message-ID:** `<gap-20f7fe75f3-p2@usenetarchives.gap>`
- **In-Reply-To:** `<4ev0b3$d2s@tofu.alt.net>`
- **References:** `<4ev0b3$d2s@tofu.alt.net>`

```
CASH MASTER (J.··.@A··.COM) wrote:

[stuff deleted]

› Let's review the reasons why you should do this: The only

Now let's review the reasons why you should *not* do this.

In many countries (incl Australia and I believe the US) it is *illegal*. I
make no moral judgements about these systems - it obviously works for some
people - but that doesn't make it legal.

There is a statement from the US Auditor General (or something like that)
floating around the net which supports my statement above.
