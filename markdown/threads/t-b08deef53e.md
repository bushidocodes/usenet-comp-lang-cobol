...
- **Message-ID:** `<cobol_812437202@hermione.demon.co.uk>`

```
Archive-name: cobol-faq
Posting-Frequency: every 30 days
Last-Modified: $Date: 1995/09/23 17:02:29 $
...
As a result of many requests, a section on COBOL Tools has been added.
Currently this only covers RM VanGui and MF Dialog System. Additions
covering other tools in a concise and hype-free manner are invited.

Added further information regarding copyright for the next COBOL
standard from Bill Klein <737··1@Com··e.COM>.
...
to be transferred between DOS/Windows, OS/2 and UNIX/X11.
