...
- **Top 1% threshold (p99):** 87 messages
- **Top 5% threshold (p95):** 29 messages
- **Median thread size:** 3 messages
- **Single-message threads:** 5,286 (32% of all threads)
...
| William Lynch | `wblynch@att.net` | 541 | 267 |
...
| Oliver Wong | `owong@castortech.com` | 479 | 93 |
