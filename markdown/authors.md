...
| 45 | [docdwarf](#a-b3f44a4934) | 485 | 159 | 10 | 1 | 2013-07 → 2022-04 |
...
| 66 | [Jeff Farkas](#a-866f3fa52d) | 279 | 173 | 23 | 13 | 1998-06 → 2001-11 |
...
| 73 | [Anonymous](#a-294de3557d) | 235 | 185 | 78 | 13 | 1994-11 → 2012-11 |
...
| 88 | [Ed Guy](#a-7b9019e3d8) | 195 | 118 | 4 | 4 | 1999-08 → 2004-01 |
| 89 | [Jack Sleight](#a-fa2d9b074a) | 195 | 124 | 1 | 1 | 2001-06 → 2006-04 |
...
| 92 | [LX-i](#a-b3302ccea2) | 190 | 48 | 11 | 1 | 2003-04 → 2003-06 |
| 93 | [Shaun C. Murray](#a-3aa838a3ec) | 190 | 120 | 6 | 3 | 1994-11 → 1999-03 |
...
| 99 | [WOB](#a-425734a42d) | 173 | 147 | 10 | 1 | 1998-07 → 2005-09 |
| 100 | [DennisHarley](#a-9aa90dd468) | 173 | 78 | 6 | 1 | 2000-01 → 2000-05 |
...
`dashwood@removethis.enternet.co.nz` (4,799), `dashwood@enternet.co.nz` (2,978), `pete.dashwood.18ysho@mail.codecomments.com` (1), `pete.dashwood.18yshn@mail.codecomments.com` (1)
...
_Also posted as: william m. klein, William M Klein, wmklein@ix.netcom.com, no spam please (Cuthbert J…._
...
`riplin@azonic.co.nz` (5,946), `ua-author-11605@usenetarchives.gap` (2), `starwulf@prodigy.net` (1), `chucks101@hotmail.com` (1)
...
_Also posted as: James J.Gavan, James. J. Gavan, J. Gavan._
...
- [Deleted records](threads/t-81e5cfbd34.md) — **11** of 45 msgs
...
- [Motivating Programmers](threads/t-6bfe7298cd.md) — **7** of 105 msgs
...
- [OT - "lie" vs "error"](threads/t-1461c1cf4b.md) — **14** of 540 msgs
...
`no@e.mail` (1,350), `0robert.jones@gmail.com` (20), `ua-author-7387749@usenetarchives.gap` (13), `gnuoytr@rcn.com` (12), `rls@nospam.thanks.com` (4), `rbnorthcutt74@yahoo.com` (3), `rlstinnett@home.com` (2), `rls@ktis.net` (2), `ua-author-10266@usenetarchives.gap` (2), `ua-author-21794@usenetarchives.gap` (1), `royprins_nospam@hetnet.nl` (1), `cali_marine_usmc@yahoo.com` (1)
...
_Also posted as: Gerry Ford, HeyBub._
...
- [FAQ "accessed counter" (and other changes)](threads/t-49d36684e1.md) — **13** of 46 msgs
...
- [Free-Cobol?](threads/t-7c1db914f1.md) — **5** of 25 msgs
...
- [An SP2 bug.](threads/t-dd3acf126d.md) — **6** of 31 msgs
...
- [IBM Mainframe COBOL "people"](threads/t-6e9cf19351.md) — **4** of 111 msgs
...
- [Comp.lang.cobol charter](threads/t-8ff4f17f08.md) — **6** of 15 msgs
...
- [Coul someone send me the ODBC cobol driver for Visual Basic.](threads/t-e0ee027907.md) — **4** of 15 msgs
- [Cobol Linear search Vs Perfrom Until](threads/t-23a980cfd3.md) — **4** of 108 msgs
...
_Also posted as: Defaultuser, news-server.tampabay.rr.com, JCE._
...
- [VSAM doubt](threads/t-4122f4cc05.md) — **10** of 113 msgs
...
- [help with tables](threads/t-84124279eb.md) — **3** of 117 msgs
...
- [Maintenance - top 10 tasks](threads/t-256a3399b0.md) — **6** of 82 msgs

## #40. Doug Miller <a id='a-919f8d3b35'></a>

`spambait@milmac.com` (288), `dxmixxer@netdirect.net` (130), `doug_at_milmac_dot_com@example.com` (49), `doug_at_milmacdotcom@example.com` (15), `dlmiller@netdirect.net` (9), `dlmiller@inetdirect.net` (7), `ua-author-95539@usenetarchives.gap` (7), `dougatmilmacdotcom@example.com` (1)
...
- [origin of 88 level](threads/t-9e44c98f45.md) — **4** of 68 msgs
...
- [[OT] Iraq](threads/t-b41850b8b6.md) — **7** of 310 msgs

## #45. docdwarf <a id='a-b3f44a4934'></a>

`ua-author-6588713@usenetarchives.gap` (485)

**485 messages** in **159 threads** (10 started) · active **2013-07 → 2022-04**
...
- [Be thankful for COBOL](threads/t-f289e075a0.md) — **9** of 42 msgs
...
- [GO TO](threads/t-3222d57323.md) — **6** of 150 msgs
...
- [The Wrong People](threads/t-99975f13f7.md) — **7** of 27 msgs
...
- [inspect v's unstring](threads/t-de0021125f.md) — **6** of 40 msgs
...
`billg999@cs.uofs.edu` (319), `bill@server1.cs.uofs.edu` (70), `bill@cs.uofs.edu` (17), `bill@server3.cs.uofs.edu` (3), `bill@triangle.cs.uofs.edu` (2), `billgggggg999@cs.uofs.edu` (1), `bill@server2.cs.uofs.edu` (1), `billig999@cs.uofs.edu` (1)
...
`praulerson@hot.nospam.rr.com` (193), `praulerson@no-spam.hot.rr.com` (39), `pkraulerson@verizon.net` (36), `praul@isot.com` (23), `praulerson@nospam-hot.rr.com` (19), `praul@isot.n0spam.com` (10), `praul@cegi.no` (7), `praul@isot.nospam.com` (7), `paul@raulersons.com` (5), `praul@cegi.net` (3), `praul@cegi-n-o-s-p-a-m.net` (1), `ua-author-6589345@usenetarchives.gap` (1), `paul.raulerson@mac.com` (1), `paulr@axs2000.net` (1)
...
- [Dumb Question 2: Start syntax](threads/t-9e3c99b9df.md) — **5** of 11 msgs · _started_
...
_Also posted as: rjones0@hotmail.com, Robert._
...
- [Retrieving values from a table](threads/t-8669c53b20.md) — **3** of 16 msgs
...
- [A Programmer's Day, Week, Year](threads/t-195aee9e33.md) — **4** of 16 msgs · _started_
...
- [J4 paper on "symbols"](threads/t-3cc145252a.md) — **9** of 179 msgs
...
- [PROCEDURE-POINTER: What problem was this trying to solve?](threads/t-503ef8ff95.md) — **3** of 18 msgs
...
- [Use of the Period](threads/t-8b65d92e6a.md) — **5** of 32 msgs
...
- [Deperate student requires help with COBOL program](threads/t-b90340f715.md) — **4** of 57 msgs
- [Coding hex in pic (mvs cobol2)](threads/t-b1b0b95b70.md) — **4** of 29 msgs
- [VS COBOL II - Accepting 9(08) date from system](threads/t-b573f38c39.md) — **4** of 18 msgs
...
- [<none>](threads/t-a8c37e096e.md) — **4** of 16 msgs
- [Can't print in MicroFocus COBOL... please help!](threads/t-1fa2534c9a.md) — **4** of 16 msgs · _started_

## #66. Jeff Farkas <a id='a-866f3fa52d'></a>

`jeffreyfarkas@earthlink.net` (128), `jeffrey.farkas@gte.net` (45), `ua-author-3652523@usenetarchives.gap` (34), `jefffarkas@noland.com` (19), `tazberjef@nospam.naxs.net` (18), `jeffreyfarkas@nospamearthlink.net` (16), `tazberjef@naxs.nospam.net` (8), `taxberjef@naspam.naxs.net` (3), `tazberjef@naxs.net` (2), `jefpicabo@aol.com` (2), `jeff_member@newsranger.com` (2), `jeffreyfarkas@hotmail.com` (1), `jeffreyfarkas@nospam.earthlink.net` (1)

**279 messages** in **173 threads** (23 started) · active **1998-06 → 2001-11**

_Also posted as: jeff farkas, Jeffrey E. Farkas, JF..Ver 2.5.5._
...
- [Full repost of: Use of ELSE-IF....](threads/t-5142175a41.md) — **4** of 13 msgs · _started_
...
- [Learning Cobol is a very enjoyable experience.](threads/t-bdcdb3fba5.md) — **4** of 35 msgs
...
- [How BIG is a mainframe?](threads/t-467c009c91.md) — **4** of 39 msgs
- [An old language called MARK4](threads/t-9852a599e6.md) — **3** of 11 msgs
...
- [Boolean Data items](threads/t-b52731765e.md) — **3** of 13 msgs · _started_
...
- [Cobol .DAT backup solution](threads/t-a040896c83.md) — **5** of 59 msgs · _started_
...
`ua-author-9618@usenetarchives.gap` (150), `mac3@slic.com` (24), `anonymous@anonymous.anonymous` (20), `federalreservebostonnofespam@juno.com.invalid` (12), `matthew.handi@thehartford.com` (7), `cripto@ecn.org` (5), `nobody@base.xs4all.nl` (4), `nobody@remailer.paranoici.org` (4), `ua-author-4@usenetarchives.gap` (3), `saurabhbh@gmail.com` (2), `nobody@replay.com` (2), `nobody@drule.org` (1), `nobody@remailer.ch` (1)

**235 messages** in **185 threads** (78 started) · active **1994-11 → 2012-11**
...
- [Need COBOL74 ANSI Spec](threads/t-df87781ba4.md) — **2** of 5 msgs · _started_
- [conversion from Microfocus NetExpress COBOL to Fujitsu netCOBOL.net](threads/t-e6187d4a60.md) — **2** of 90 msgs · _started_
...
- [Crystal Reports Engine & COBOL](threads/t-d14f7eec84.md) — **3** of 6 msgs
...
- [Defensive programming](threads/t-35aca9a30b.md) — **3** of 18 msgs
...
- [brain teaser](threads/t-64f87cec32.md) — **5** of 45 msgs
- [EXTERNAL clarification](threads/t-8fe6d49b2c.md) — **5** of 23 msgs · _started_

## #77. Warren Porter <a id='a-dab4deac81'></a>

`warrenp123@netdoor123.com` (99), `warrenp@aspmnetdoor.com` (73), `wb999port@bellsouth12.net` (23), `wb999port@bellsouth.net` (7), `wbport4@bellsouth3.net` (5), `warrenp21@aspmnetdoor.com` (3), `warrenp@netdoornospam.com` (3), `wbport99@bellsouth45.net` (2), `warrenp@netdoor.com` (2), `wbport@bellsouthmasp.net` (1), `wb7port@bell3south.net` (1)
...
- [How to compute Easter](threads/t-7650435806.md) — **3** of 27 msgs
- [COBOL Tips and Techniques](threads/t-f2c0d5d8fd.md) — **3** of 26 msgs · _started_
- [Experiences in Migrating IBM COBOL to Language Environment?](threads/t-8884c8a9fb.md) — **3** of 5 msgs · _started_
- [any pointers to using COBOL for OS/390 TEST(,,SEPARATE)](threads/t-50073eb886.md) — **3** of 8 msgs
- [Case Statement in DB2](threads/t-d6c2397778.md) — **3** of 12 msgs
...
- [Pay questions](threads/t-e25d98f24d.md) — **3** of 19 msgs
- [What is a level 77](threads/t-f1ecd380c2.md) — **3** of 34 msgs
- [GO TO less purists, how would you do this?](threads/t-4178dbd7cb.md) — **3** of 45 msgs
- [When is a Binary field Numeric](threads/t-f4fc7f2090.md) — **3** of 8 msgs · _started_
...
- [Use of SECTION](threads/t-32502da619.md) — **2** of 91 msgs
...
- [When will COBOL die??](threads/t-25b756d32a.md) — **2** of 9 msgs
- [Forgive me--seemed appropriate-OT](threads/t-c797ba86df.md) — **2** of 9 msgs
- [������������������ ������������](threads/t-171df97e8f.md) — **2** of 16 msgs
...
- [[job] Cobol Programmer needed-rate range](threads/t-f48340aac0.md) — **3** of 72 msgs
...
- [Can coBol imitates a kangaroo?...](threads/t-ab7cdc42ef.md) — **5** of 14 msgs · _started_
...
- [Splitting output file](threads/t-6daac9c8c0.md) — **3** of 27 msgs
- [IBM Mainframe COBOL "people"](threads/t-6e9cf19351.md) — **3** of 111 msgs
- [CSV Files](threads/t-e43e7d5730.md) — **3** of 19 msgs

## #89. Jack Sleight <a id='a-fa2d9b074a'></a>
...
- [Micro Focus Dialog](threads/t-d5ad4aca62.md) — **2** of 6 msgs
...
- [XML proposal initial input for future COBOL Standard](threads/t-6b1c0957a0.md) — **4** of 30 msgs

## #93. Shaun C. Murray <a id='a-3aa838a3ec'></a>
...
- [Cobol Forever!](threads/t-1965af118b.md) — **3** of 36 msgs
...
- [Paragraph Numbering and Program Structure](threads/t-f6080ecc83.md) — **4** of 56 msgs
- [Perform "Standards" question](threads/t-c76e7c73e1.md) — **4** of 74 msgs
...
- [Layout Hell.](threads/t-ef2a0e3b37.md) — **3** of 96 msgs
...
- [MF COBOL and UNIX question](threads/t-a9d89e50ec.md) — **2** of 5 msgs
- [Getting Process id in MFCOBOL under UNIX](threads/t-0c3674527c.md) — **2** of 9 msgs
- [132 column display](threads/t-bf84dc6b1e.md) — **2** of 9 msgs
- [<<< MF 2.4.38 Compiler Problems - PLEASE HELP! >>>](threads/t-d9d2c1e8ba.md) — **2** of 5 msgs
- [Help with MicroFocus COBOL and C++ integration on UNIX](threads/t-27eddedd16.md) — **2** of 6 msgs
- [Is MF COBOL unable to run large applications?](threads/t-b7b7d2bf82.md) — **2** of 7 msgs
...
- [WINAPI calls - Is there A tutorial??](threads/t-b253ab59a7.md) — **1** of 4 msgs
- [COBOL to do CGI?](threads/t-b2a5b3bcda.md) — **1** of 4 msgs
- [MF V3.1 COBOL Problem](threads/t-aa4f78cfe1.md) — **1** of 3 msgs
- [Help wanted for Table Index or Subscript.](threads/t-7258acf886.md) — **1** of 7 msgs
- [INITIALIZE and FILLER question](threads/t-1fc4af724d.md) — **1** of 2 msgs
- [DOS Function call help](threads/t-46e71c0197.md) — **1** of 2 msgs
- [Recipe for MF COBOL to C Program connectivity?](threads/t-a2e72b1cc1.md) — **1** of 5 msgs
- [Help for a starting Cobol Student - PC Cobol Info](threads/t-e68ec70811.md) — **1** of 2 msgs
- [Can I get "Subscript out of range" error message from C program](threads/t-e87cf3a24c.md) — **1** of 7 msgs
...
- [Java to COBOL](threads/t-1194487823.md) — **2** of 23 msgs
- [Success stories for Cobol](threads/t-96a5a3cd70.md) — **2** of 77 msgs
- [Problems with MF Workbench 4.0.7 and COMMDLG32.DLL](threads/t-be1166b9cf.md) — **2** of 7 msgs
- [MFC OR Microsoft](threads/t-9783b94fdc.md) — **2** of 12 msgs
- [Microfocus Cobol](threads/t-9b3798a4ce.md) — **2** of 16 msgs

## #99. WOB <a id='a-425734a42d'></a>
...
- [From PARM= to PROC DIV USING?](threads/t-a13f473377.md) — **2** of 19 msgs
- [Want to know length of the field passed to a program](threads/t-c267519a01.md) — **2** of 23 msgs
- [packed field handling - no sign](threads/t-4f24537094.md) — **2** of 12 msgs
- [ELIF Proposal](threads/t-8ecfce6e34.md) — **2** of 91 msgs
- [External Table Addressability using Procedure-Pointer](threads/t-375cdb3d50.md) — **2** of 3 msgs · _started_

## #100. DennisHarley <a id='a-9aa90dd468'></a>
